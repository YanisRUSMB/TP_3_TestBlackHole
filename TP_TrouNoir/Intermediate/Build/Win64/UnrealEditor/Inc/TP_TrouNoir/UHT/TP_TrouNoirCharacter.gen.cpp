...
struct Z_CompiledInDeferFile_FID_Users_reyna_Documents_Unreal_Projects_TP_3_TestBlackHole_TP_TrouNoir_Source_TP_TrouNoir_TP_TrouNoirCharacter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATP_TrouNoirCharacter, ATP_TrouNoirCharacter::StaticClass, TEXT("ATP_TrouNoirCharacter"), &Z_Registration_Info_UClass_ATP_TrouNoirCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATP_TrouNoirCharacter), 2450442796U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_reyna_Documents_Unreal_Projects_TP_3_TestBlackHole_TP_TrouNoir_Source_TP_TrouNoir_TP_TrouNoirCharacter_h_32325418(TEXT("/Script/TP_TrouNoir"),
